...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 03, 2026 lúc 02:17 PM
...
(7, 'An toàn thông tin', 'Bảo mật hệ thống và phòng chống tấn công mạng'),
...
--
-- Đang đổ dữ liệu cho bảng `coding_exercises`
--
...
(30, 57, 'Bài 1: C Hello World', '<h3>Đề bài:</h3><p>Sử dụng <code>printf</code> để in ra: <b>Hello C Language</b></p>', '#include <stdio.h>\n\nint main() {\n    printf(\"Hello C Language\");\n    return 0;\n}', NULL, 'Hello C Language', 10, 'c'),
(31, 57, 'Bài 2: Tính diện tích HCN', '<h3>Đề bài:</h3><p>Tính diện tích hình chữ nhật có dài=10, rộng=5. In kết quả ra màn hình.</p>', '#include <stdio.h>\n\nint main() {\n    int w = 5, h = 10;\n    printf(\"%d\", w * h);\n    return 0;\n}', NULL, '50', 10, 'c'),
(32, 48, 'Bài 1: Hello React World', '<h3>Đề bài:</h3><p>Hãy in ra màn hình dòng chữ: <b>Hello React</b></p>', 'console.log(\"Hello React\");', NULL, 'Hello React', 10, 'nodejs'),
(33, 48, 'Bài 2: ES6 Arrow Function', '<h3>Đề bài:</h3><p>Viết một Arrow Function tính tổng 2 số 10 và 20 và in ra kết quả.</p>', 'const sum = (a, b) => a + b;\nconsole.log(sum(10, 20));', NULL, '30', 10, 'nodejs'),
(34, 48, 'Bài 3: Xử lý mảng (Map)', '<h3>Đề bài:</h3><p>Cho mảng [1, 2, 3]. Hãy in ra mảng mới với các giá trị gấp đôi. Format in: <b>2,4,6</b></p>', 'const arr = [1, 2, 3];\nconst doubled = arr.map(x => x * 2);\nconsole.log(doubled.join(\",\"));', NULL, '2,4,6', 10, 'nodejs'),
(35, 56, 'Bài 1: Xin chào Java', '\r\n    <div class=\"theory-box\">\r\n        <b>Kiến thức:</b> Mọi chương trình Java đều bắt đầu từ một <code>class</code> và hàm <code>main</code>.\r\n    </div>\r\n\r\n    <h3>1. Lệnh in ra màn hình</h3>\r\n    <p>Trong Java, lệnh in đầy đủ là:</p>\r\n    <code>System.out.println(\"Nội dung\");</code>\r\n\r\n    <div class=\"example-box\">\r\n        <b>Ví dụ:</b>\r\n        <pre>\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        System.out.println(\"Xin chao!\");\r\n    }\r\n}</pre>\r\n    </div>\r\n\r\n    <h3>2. Nhiệm vụ</h3>\r\n    <p>Hoàn thành code để in ra dòng chữ: <b class=\"highlight\">Hello Java</b></p>\r\n', 'public class Main {\n    public static void main(String[] args) {\n        System.out.println(\"Hello Java\");\n    }\n}', NULL, 'Hello Java', 10, 'java'),
(36, 56, 'Bài 2: Tính tổng mảng', '<h3>Đề bài:</h3><p>Tính tổng các số từ 1 đến 5 (1+2+3+4+5) và in ra kết quả.</p>', 'public class Main {\n    public static void main(String[] args) {\n        int sum = 0;\n        for(int i=1; i<=5; i++) sum += i;\n        System.out.println(sum);\n    }\n}', NULL, '15', 10, 'java'),
(37, 53, 'Bài 3: Kiểm tra số chẵn lẻ', '<h3>Đề bài:</h3><p>Kiểm tra số 10 là chẵn hay lẻ? Nếu chẵn in <b>Even</b>, lẻ in <b>Odd</b>.</p>', 'public class Main {\n    public static void main(String[] args) {\n        int n = 10;\n        if(n % 2 == 0) System.out.println(\"Even\");\n        else System.out.println(\"Odd\");\n    }\n}', NULL, 'Even', 10, 'java'),
(38, 50, 'Bài 1: C++ Hello World', '<h3>Đề bài:</h3><p>Sử dụng <code>cout</code> để in ra: <b>Hello CPP</b></p>', '#include <iostream>\nusing namespace std;\n\nint main() {\n    cout << \"Hello CPP\";\n    return 0;\n}', NULL, 'Hello CPP', 10, 'cpp'),
(39, 50, 'Bài 2: Con trỏ cơ bản', '<h3>Đề bài:</h3><p>Khai báo biến a = 100. Dùng con trỏ để in ra giá trị của a.</p>', '#include <iostream>\nusing namespace std;\n\nint main() {\n    int a = 100;\n    int* ptr = &a;\n    cout << *ptr;\n    return 0;\n}', NULL, '100', 10, 'cpp'),
(40, 57, 'Bài 1: C Hello World', '<h3>Đề bài:</h3><p>Sử dụng <code>printf</code> để in ra: <b>Hello C Language</b></p>', '#include <stdio.h>\n\nint main() {\n    printf(\"Hello C Language\");\n    return 0;\n}', NULL, 'Hello C Language', 10, 'c'),
(41, 57, 'Bài 2: Tính diện tích HCN', '<h3>Đề bài:</h3><p>Tính diện tích hình chữ nhật có dài=10, rộng=5. In kết quả ra màn hình.</p>', '#include <stdio.h>\n\nint main() {\n    int w = 5, h = 10;\n    printf(\"%d\", w * h);\n    return 0;\n}', NULL, '50', 10, 'c'),
(42, 67, 'Bài 1: Hello C', '\r\n    <div class=\"theory-box\">\r\n        <b>Mục tiêu:</b> Làm quen với cấu trúc cơ bản của một chương trình C và hàm xuất dữ liệu ra màn hình.\r\n    </div>\r\n\r\n    <h3>1. Thư viện chuẩn</h3>\r\n    <p>Để sử dụng các hàm nhập xuất, ta cần khai báo thư viện:</p>\r\n    <pre>#include &lt;stdio.h&gt;</pre>\r\n\r\n    <h3>2. Hàm printf</h3>\r\n    <p>Hàm <code>printf</code> dùng để in chuỗi hoặc giá trị biến ra màn hình console.</p>\r\n    \r\n    <div class=\"example-box\">\r\n        <b>Ví dụ mẫu:</b>\r\n        <pre>\r\n#include &lt;stdio.h&gt;\r\n\r\nint main() {\r\n    // In ra dòng chữ Hello\r\n    printf(\"Hello World\"); \r\n    return 0;\r\n}</pre>\r\n    </div>\r\n\r\n    <h3>3. Yêu cầu bài tập</h3>\r\n    <p>Hãy viết chương trình sử dụng <code>printf</code> để in ra chính xác dòng chữ: <b class=\"highlight\">Chao EduPath</b></p>\r\n', '#include <stdio.h>\n\nint main() {\n    // Code here\n    return 0;\n}', NULL, 'Chao EduPath', 10, 'c'),
(43, 67, 'Bài 2: Tính tổng 2 số', '<h3>Đề bài:</h3><p>Khai báo a=5, b=10. Tính tổng và in ra kết quả (dùng %d).</p>', '#include <stdio.h>\n\nint main() {\n    int a=5, b=10;\n    printf(\"%d\", a+b);\n    return 0;\n}', NULL, '15', 10, 'c'),
(44, 68, 'Bài 1: Hello C++', '\r\n    <div class=\"theory-box\">\r\n        <b>Lý thuyết:</b> Trong C++, chúng ta sử dụng đối tượng <code>cout</code> (thuộc thư viện <code>iostream</code>) để xuất dữ liệu.\r\n    </div>\r\n\r\n    <h3>1. Cấu trúc lệnh</h3>\r\n    <p>Cú pháp cơ bản:</p>\r\n    <pre>std::cout &lt;&lt; \"Nội dung cần in\";</pre>\r\n    <p>Nếu đã khai báo <code>using namespace std;</code> thì chỉ cần dùng <code>cout</code>.</p>\r\n\r\n    <div class=\"example-box\">\r\n        <b>Ví dụ minh họa:</b>\r\n        <pre>\r\n#include &lt;iostream&gt;\r\nusing namespace std;\r\n\r\nint main() {\r\n    cout &lt;&lt; \"Hoc Lap Trinh\";\r\n    return 0;\r\n}</pre>\r\n    </div>\r\n\r\n    <h3>2. Yêu cầu</h3>\r\n    <p>Hãy in ra dòng chữ: <b class=\"highlight\">I love C++</b></p>\r\n', '#include <iostream>\nusing namespace std;\n\nint main() {\n    // Code here\n    return 0;\n}', NULL, 'I love C++', 10, 'cpp'),
(45, 68, 'Bài 2: Vòng lặp For', '<h3>Đề bài:</h3><p>In các số từ 1 đến 3, cách nhau bởi dấu cách.</p>', '#include <iostream>\nusing namespace std;\n\nint main() {\n    for(int i=1; i<=3; i++) cout << i << \" \";\n    return 0;\n}', NULL, '1 2 3 ', 10, 'cpp'),
(46, 69, 'Bài 1: Hello Java', '<h3>Đề bài:</h3><p>In ra màn hình: <b>Java is powerful</b></p>', 'public class Main {\n    public static void main(String[] args) {\n        System.out.println(\"Java is powerful\");\n    }\n}', NULL, 'Java is powerful', 10, 'java'),
(47, 69, 'Bài 2: Mảng String', '<h3>Đề bài:</h3><p>Tạo mảng tên {\"Lan\", \"Diep\"}. In ra phần tử thứ 2 (index 1).</p>', 'public class Main {\n    public static void main(String[] args) {\n        String[] names = {\"Lan\", \"Diep\"};\n        System.out.println(names[1]);\n    }\n}', NULL, 'Diep', 10, 'java');
...
(57, 7, 'Ethical Hacking 101', 'Bảo mật hệ thống căn bản', 'Học cách hacker tấn công để bảo vệ hệ thống của bạn.', 1800000.00, 1450000.00, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS50rsBNooFSLZK85hz6bKymu-Mq4nra-RG0A&s', 'English', 'Intermediate', 'Active', NULL, '2026-02-08 13:43:58', '2026-02-08 14:14:07', 758),
(58, 7, 'Network Security Fundamentals', 'An ninh mạng doanh nghiệp', 'Thiết lập tường lửa và hệ thống phòng thủ mạng.', 1200000.00, 0.00, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRczYyF0bIYlnjGHdSx323vx931KJhSIUxAgw&s', 'Vietnamese', 'Intermediate', 'Active', NULL, '2026-02-08 13:43:58', '2026-02-08 14:14:07', 340),
...
(65, 11, 'English for IT Professionals', 'Tiếng Anh cho dân công nghệ', 'Giao tiếp và làm việc với khách hàng quốc tế.', 950000.00, 750000.00, 'https://m.media-amazon.com/images/I/71MW9mwye5L._UF1000,1000_QL80_.jpg', 'English', 'Beginner', 'Active', NULL, '2026-02-08 13:43:58', '2026-02-08 14:14:07', 489),
(66, 11, 'Reading Technical Docs', 'Đọc tài liệu kỹ thuật chuyên sâu', 'Kỹ năng đọc hiểu các document như MDN, JavaDocs.', 700000.00, 490000.00, 'https://i.ytimg.com/vi/lwqeNnboh_4/maxresdefault.jpg', 'English', 'Intermediate', 'Active', NULL, '2026-02-08 13:43:58', '2026-02-08 14:14:07', 926),
(67, 2, 'Lập trình C: Nền tảng cho mọi ngôn ngữ', NULL, 'Khóa học C căn bản giúp bạn hiểu sâu về bộ nhớ, con trỏ và tư duy lập trình hệ thống. Bước đệm để học mọi ngôn ngữ khác.', 500000.00, 0.00, 'https://topdev.vn/blog/wp-content/uploads/2019/04/blog6.png', NULL, 'Beginner', 'active', NULL, '2026-02-14 08:43:22', '2026-02-14 08:45:44', 1200),
...
INSERT INTO `enrollments` (`enrollment_id`, `user_id`, `course_id`, `enrolled_at`, `progress_percent`, `status`) VALUES
(1, 4, 67, '2026-03-02 14:15:26', 66, 'active'),
(2, 4, 49, '2026-03-02 15:07:53', 0, 'active');
...
(2, 4, 'Đăng ký thành công', 'Bạn đã sở hữu khóa học: Python for AI & Machine Learning. Hãy bắt đầu học ngay!', 'SUCCESS', 0, '2026-03-02 15:07:53');
...
(4, 'gg_103552638626408368850', 'Nguyễn Anh Dương', 'duonganhdn2000@gmail.com', NULL, '/userAvatar/4.jpg', 'student', '2026-02-28 07:14:05', '2026-03-02 12:50:16', 1, 'GOOGLE', '103552638626408368850');
