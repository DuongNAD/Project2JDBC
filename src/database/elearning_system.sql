...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 05, 2026 lúc 03:12 PM
...
INSERT INTO `categories` (`category_id`, `name`, `description`) VALUES
                                                                    ...
                                                                    (7, 'An toàn thông tin', 'Bảo mật an toàn hệ thống và phòng chống tấn công mạng'),
...
INSERT INTO `enrollments` (`enrollment_id`, `user_id`, `course_id`, `enrolled_at`, `progress_percent`, `status`, `rating`) VALUES
                                                                                                                               (1, 4, 67, '2026-03-02 14:15:26', 66, 'active', 4),
                                                                                                                               (2, 4, 49, '2026-03-02 15:07:53', 100, 'active', 3);
...
INSERT INTO `users` (`user_id`, `user_name`, `full_name`, `email`, `password_hash`, `avatar_url`, `role`, `created_at`, `updated_at`, `is_active`, `auth_provider`, `provider_id`) VALUES
                                                                                                                                                                                       ...
                                                                                                                                                                                       (4, 'gg_103552638626408368850', 'Nguyễn Anh Dương', 'duonganhdn2000@gmail.com', NULL, '/userAvatar/4.jpg', 'student', '2026-02-28 07:14:05', '2026-03-05 13:08:11', 1, 'GOOGLE', '103552638626408368850');
...
--
ALTER TABLE `lesson_progress`
    MODIFY `progress_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
